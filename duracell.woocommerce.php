...
function gtm4wp_woocommerce_datalayer_filter_items( $dataLayer ) {
	...
	/*		if ( $gtm4wp_options[ GTM4WP_OPTION_INTEGRATE_WCEXCLUDETAX ] ) {
			...
			$order_revenue = (float)( $gtm4wp_is_woocommerce3 ? $order->get_shipping_total() : $order->get_total_shipping() );
			if ( $gtm4wp_is_woocommerce3 ) {
		...
		/*		$dataLayer["transactionTotal"]          = ( $gtm4wp_is_woocommerce3 ? $order->get_shipping_total() : $order->get_total_shipping());*/				
